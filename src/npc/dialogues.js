...
export const DIALOGUES = [
  ...
  D('bus-altstadt', ['bus', 'südgelände', 'tennenlohe'], {
  ...
  // ---------------- Altstadt (Schloss, Schlossgarten, Kollegienhaus) ----------------
  D('alt-schloss', ['altstadt', 'schlossgarten'], {
    start: n('Schönes Plätzchen, oder? Bist du zum ersten Mal hier am Schloss?', '这地方不错吧？你第一次来宫殿这边吗？',
      [o('Ja. Wer wohnt denn im Schloss?', '是的。宫殿里住着谁？', 'who'), o('Gehört das auch zur Uni?', '这也属于大学吗？', 'uni')]),
    who: n('Wohnen tut da niemand mehr – heute sitzt im Schloss die Verwaltung der Universität. Gebaut wurde es für die Markgrafen.',
      '现在没人住了——宫殿如今是大学的行政部门所在地。当年是为边疆伯爵（Markgraf）修建的。',
      [o('Kann man hinein?', '可以进去参观吗？', 'visit'), o('Spannend, danke!', '真有意思，谢谢！')]),
    visit: n('Es ist ein Verwaltungsgebäude, kein Museum. Ob es Führungen gibt und wann, steht auf den Seiten der Stadt oder der FAU.',
      '那是行政楼，不是博物馆。有没有导览、什么时候有，以市政府或 FAU 官网为准。', [BYE]),
    uni: n('Ja, in der Innenstadt ist die Uni an vielen Stellen: Schloss, Kollegienhaus, die Hauptbibliothek … Die Technische Fakultät liegt dagegen im Süden, auf dem Südgelände.',
      '是的，大学在市中心分布在好几处：宫殿、学院楼（Kollegienhaus）、总图书馆……而工学院在城南的南校区（Südgelände）。',
      [o('Wie komme ich dorthin?', '怎么去那儿？', 'way'), BYE]),
    way: n('Zu Fuß geht es nach Süden, durch den Röthelheimpark – mit dem Rad ist es bequemer. Busverbindungen zeigt dir die VGN-Auskunft, die ist aktueller als ich.',
      '步行往南穿过 Röthelheimpark，骑车更方便。公交线路以 VGN 官方查询为准，比我记得准。', [BYE]),
  }),
  D('alt-garten', ['schlossgarten'], {
    start: n('Hi! Lernst du auch lieber draußen?', '嗨！你也喜欢在户外学习吗？',
      [o('Ja, hier ist es schön ruhig.', '是啊，这里很安静。', 'calm'), o('Was ist das lange Gebäude dort?', '那边那栋长长的建筑是什么？', 'oran'), o('Was ist das für ein Brunnen?', '这是什么喷泉？', 'brunnen')]),
    calm: n('Bei schönem Wetter liegen hier viele Studis auf der Wiese. Achte nur auf die Schilder – nicht jede Fläche darf man betreten.',
      '天气好时很多学生躺在草坪上。注意看告示牌——不是每块草地都能进去。', [BYE]),
    oran: n('Das ist die Orangerie. Früher überwinterten darin die Orangenbäume – daher der Name.',
      '那是橘园（Orangerie）。以前冬天橘子树放在里面过冬，所以叫这个名字。', [o('Ach so, danke!', '原来如此，谢谢！')]),
    brunnen: n('Der Hugenottenbrunnen. Oben auf dem Felsenberg steht der Markgraf, unten sind Bürger und Hugenotten dargestellt – die Hugenotten haben die Neustadt mit aufgebaut.',
      '胡格诺喷泉（Hugenottenbrunnen）。岩山顶上是边疆伯爵，下面刻画的是市民和胡格诺派教徒——新城就是胡格诺派参与建起来的。', [o('Interessant!', '很有意思！')]),
  }),
  D('alt-kolleg', ['altstadt', 'aula'], {
    start: n('Suchst du das Kollegienhaus?', '你在找学院楼（Kollegienhaus）吗？',
      [o('Ja – was ist dort?', '是的——那里有什么？', 'what'), o('Nein, danke.', '不用了，谢谢。')]),
    what: n('Hörsäle und die Aula, in der Festakte und Vorträge stattfinden. Was gerade läuft, steht im Veranstaltungskalender der FAU.',
      '里面有报告厅和大礼堂（Aula），典礼和报告会在那里举行。最近有什么活动，以 FAU 官网的活动日历为准。',
      [o('Und wie alt ist das Gebäude?', '这栋楼有多老了？', 'age'), BYE]),
    age: n('Gebaut wurde es Ende des 19. Jahrhunderts – drei Pavillons, in der Mitte mit dem kleinen Uhrtürmchen.',
      '建于 19 世纪末——三座相连的楼，中间那座上面有个小钟塔。', [o('Danke!', '谢谢！')]),
  }),
  D('aula-quiet', ['aula'], {
    start: n('Pssst … heute ist es hier ganz ruhig. Schöner Saal, oder?', '嘘……今天这里很安静。礼堂很漂亮吧？',
      [o('Was findet hier sonst statt?', '平时这里有什么活动？', 'what'), BYE]),
    what: n('Feiern, Festvorträge, manchmal Konzerte. Die Termine stehen im Veranstaltungskalender der Uni.',
      '典礼、庆典报告，有时还有音乐会。具体日程以大学官网活动日历为准。', [o('Danke!', '谢谢！')]),
  }),
  D('staff-help-alt', ['staffalt'], {
    start: n('Guten Tag! Kann ich Ihnen helfen?', '您好！需要帮忙吗？',
      [o('Gibt es hier in der Innenstadt eine Mensa?', '市中心这边有 Mensa 吗？', 'mensa'), o('Wo ist die Unibibliothek?', '大学图书馆在哪儿？', 'ub')]),
    mensa: n('Ja, im Studentenhaus am Langemarckplatz. Öffnungszeiten und Speiseplan stehen beim Studierendenwerk.',
      '有，在 Langemarckplatz 的学生会馆（Studentenhaus）里。开放时间和菜单以 Studierendenwerk 官网为准。', [o('Vielen Dank!', '非常感谢！')]),
  ...
  D('tennenlohe-way', ['tennenlohe'], {
    start: n('Hallo! Bist du auch in einem der Institute hier?', '你好！你也在这边的研究所吗？',
      [o('Nein, zu Besuch. Wie komme ich zum Südgelände?', '不是，来参观的。怎么去南校区？', 'way'), o('Was gibt es hier eigentlich?', '这里都有什么？', 'what')]),
    way: n('Nach Norden, ein Stück durch den Wald – mit dem Rad geht das gut. Busverbindungen findest du in der VGN-Auskunft.',
      '往北走，要穿过一段森林——骑车很方便。公交以 VGN 官方查询为准。', [BYE]),
    what: n('Forschungsinstitute und Firmen, zum Beispiel Fraunhofer, und auch einige Lehrstühle der FAU.',
      '有研究机构和公司，比如弗劳恩霍夫研究所，也有 FAU 的一些教研室。', [o('Danke!', '谢谢！')]),
  }),
  D('staff-help', ['staff'], {
    start: n('Guten Tag! Kann ich Ihnen helfen?', '您好！需要帮忙吗？',
